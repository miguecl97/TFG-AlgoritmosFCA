...
This file creates graphics with the algorithms time of the sponges dataset
@author: miguelcant
"""
...
#plt.show()
plt.savefig("/home/miguelcant/Documentos/FCA_mcantarero/images/comparative-sponges.png")