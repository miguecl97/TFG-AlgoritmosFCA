...
set output 'M100g10G100500notadd.svg'
...
set grid ls 100
set title "|M|=100 , |g\'|=10"
set xlabel '|G|'
set ylabel 'Tiempo(ms)'
plot 'table100-500.csv' using 1:2 title 'NextClosure' with linespoints ls 101, 'table100-500.csv' using 1:3 title 'Lindig' with linespoints ls 102, 'table100-500.csv' using 1:4 with linespoints  title 'Inherit-Concepts' ls 104,'table100-500.csv' using 1:5 with linespoints title 'InClose' ls 105, 'table100-500.csv' using 1:6 with linespoints title 'Bordat' ls 106, 'table100-500.csv' using 1:7 with linespoints title 'Godin' ls 107, 'table100-500.csv' using 1:8 with linespoints title 'Norris' ls 103
